...
abstract class ThreeWheeled implements Vehicles1 {

	static {
		System.out.println("You are viewing Three Wheeled vehicles");
	}
	public void costing(){
		System.out.println("The cost of these vehicles are within 1 lakh");
	}
	ThreeWheeled(){
