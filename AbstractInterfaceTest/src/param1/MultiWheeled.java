...
abstract class MultiWheeled implements Vehicles1{

	static {
		System.out.println("You are viewing Multi Wheeled vehicles");
	}
	public void costing(){
		System.out.println("The cost of these vehicles are within 20 lakh");
	}
	MultiWheeled(){
		System.out.println("Year of manufacture is:"+year_of_manufacture);
	}
	public void multiwheels() {
		if(license==true) {
